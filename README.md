...
```
package com.javasampleapproach.kotlin.datetime
...
fun main(args : Array<String>){
	...
	////////////////////////////////////////////////
	// I. LocalDateTime - Get current Date & Time
	////////////////////////////////////////////////
        println("-----------------------------I-----------------------------")
	...
	/*
		2121-01-25T13:46:52.125
	*/
	
	
	/*********************************************
	 1. use defined constant of DateTimeFormatter
	*********************************************/
	println("----------------------1.----------------------------")
	// format
	...
	*/
	...
	/*********************************************
	 2. use Pattern with DateTimeFormatter.ofPattern()
	*********************************************/
	println("----------------------2.----------------------------")
	println(currentDateTime.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")))
	/*
		2121-01-25 14:02:15
	*/
	
	println(currentDateTime.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm")))
	/*
		2121-01-25 14:02
	*/
	
	/*********************************************
	 3. use Locale with DateTimeFormatter.ofLocalizedDate()
	*********************************************/
	println("----------------------3.----------------------------")
	//
	// 3.1 just current Date
	//
	...
	*/
	...
	/*
		Thursday, January 25, 2121
	*/
	
	//
	// 3.2 just current Time
	//
	...
	*/
	...
	/*
		Thursday, January 25, 2121 2:14:58 PM
	*/
	
	/////////////////////////////////////////////////////////
	// II. LocalDate & LocalTime - Get Current Date & Time
	/////////////////////////////////////////////////////////
	println("-----------------------------II-----------------------------")
	val currentDate = LocalDate.now()
	println(currentDate.format(DateTimeFormatter.ofLocalizedDate(FormatStyle.FULL)))
	/*
		Thursday, January 25, 2121
	*/
	...
	*/
	...
	////////////////////////////////////////////////////////
	// III. ZonedDateTime - get current Date & Time with TimeZone
	////////////////////////////////////////////////////////
	println("-----------------------------III-----------------------------")
	...
	/*
		2121-01-25T07:41:02.296Z[Europe/London]
	*/
	...
	println(londonDateAndTime)
	/*
		Thursday, January 25, 2121 7:40:34 AM
	*/
